...
public class ProcessosJPanel extends SuperVisorJpanel {
    
    private static final long serialVersionUID = 1L;

    private static final String PROCESSES = "Processos";
    private static final String[] COLUMNS = { "PID", "PPID", "Núcleos", "% CPU", "Acumulados", "VSZ", "RSS", "% Memória",
            "Nome do processo" };
    ...
    private transient JRadioButton perProc = new JRadioButton("Por processador");
    private transient JRadioButton perSystem = new JRadioButton("Pelo sistema");

    private transient ButtonGroup sortOption = new ButtonGroup();
    private transient JRadioButton cpuButton = new JRadioButton("CPU %");
    private transient JRadioButton cumulativeCpuButton = new JRadioButton("CPUs acumuladas");
    private transient JRadioButton memButton = new JRadioButton("Memória %");

    public ProcessosJPanel(SystemInfo si) {
        super();
        init(si);
    }
    ...
    private void init(SystemInfo si) {
        ...
        JLabel sortChoice = new JLabel("          Ordenar por:");
