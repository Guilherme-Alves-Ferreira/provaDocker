 ...
 */
public class OsHwTextPanel extends SuperVisorJpanel { // NOSONAR squid:S110

    private static final long serialVersionUID = 1L;

    private static final String OPERATING_SYSTEM = "Sistema operacional";
    private static final String HARDWARE_INFORMATION = "Informação do hardware";
    private static final String PROCESSOR = "Processador";
    private static final String DISPLAYS = "Monitores";
